    ...
    public partial class ОбращениеE : BaseEditForm<Обращение>
    {
        ...
        protected override void PreApplyToControls()
        {
            ...
            var workersActual = from w in workers
                                ...
                                select w;
            //Привязываем запрос
            ctrlОтветственныйСотрудник.LimitFunction = LinqToLcs.GetLcs(workersActual.Expression, Сотрудник.Views.СотрудникL).LimitFunction;
            ctrlПринявшийОператор.LimitFunction = LinqToLcs.GetLcs(workersActual.Expression, Сотрудник.Views.СотрудникL).LimitFunction;
        }
        ...
        protected override void PostApplyToControls()
        {
            ...
            ctrlПервичное.PropertyToShow = Information.ExtractPropertyPath<Обращение>(t => t.Первичное);
        ...
        private void ctrlВидChanged(string masterSelectedPk, ref string selectedPk, List<MasterLookup> masterLookups)
        {
            ...
            var ds = (SQLDataService)DataServiceProvider.DataService;
            var approveKind = ds.Query<ВидОбращени>(ВидОбращени.Views.ВидОбращениL).First(v => v.__PrimaryKey.ToString() == masterSelectedPk);
